   ...
   <div class="container">
      <div class="heading">
         <span class="icon-logo">
            {{-- <img src="{{ ($app) ? 'storage/'.$app->icon_logo_path:'images/icon-logo.png' }}" alt="#"> --}}
            <img src="{{ asset('images/icon-logo.png') }}" alt="Logo">
         </span>
      ...
      <div class="row">
         <div class="col-md-6">
            <div class="message-box">
               ...
               <a href="{{ url('/services') }}" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">Learn More</a>
            </div>
            <!-- end messagebox -->
         </div>
         <!-- end col -->
...
<div id="doctors" class="parallax section db" data-stellar-background-ratio="0.4" style="background:#fff;" data-scroll-id="doctors" tabindex="-1">
  <div class="container">
   ...
   <div class="heading">
         <span class="icon-logo"><img src="{{ asset('images/icon-logo.png') }}" alt="Logo"></span>
         <h2>The Specialist Clinic</h2>
      </div>

      <div class="row dev-list text-center">

        @forelse (\App\Models\Employee::where('position', 'doctor')->paginate(3) as $doctor)
