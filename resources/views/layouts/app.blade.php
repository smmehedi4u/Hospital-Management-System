                    ...
                    <div class="header-info">
                        ...
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $settings["email"] ?? 'lifecare@gmail.com' }}">{{ $settings["email"] ?? 'lifecare@gmail.com' }}</a></span>
                        </div>
                        <div class="info-inner">
                ...
                <nav class="main-menu">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li onclick="check_active('Login')"><a id="Login" data-scroll
                ...
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-map-marker"
                                aria-hidden="true"></i>{{ $settings["address"] ?? 'distric abc P/O xyz dhaka' }}
                        </p>
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i>{{ $settings["email"] ?? 'lifecare@gmail.com' }}
                        </p>
