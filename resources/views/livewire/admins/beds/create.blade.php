            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_bed()">
                        ...
                        {{-- <div class="form-group">
                            <label for="status">Avalability</label>
                            <select name="status" wire:model.lazy="status" class="form-control">
                                <option value="Available" class="text-red">{{ __('Available') }}</option>
                                <option value="Unavailable" class="text-red">{{ __('Unavailable') }}</option>
                            </select>
                            @error('status')
                                <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            <label for="d_time">Discharge Time</label>
