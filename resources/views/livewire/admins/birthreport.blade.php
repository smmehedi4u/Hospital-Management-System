    ...
    <div class="content">
        <div class="container">
            <div class="page-title">
                <h3 class="text-info">Birth Reports</h3>
            </div>
            <div>
                ...
                <div class="box-body">
                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_birthreport()">
                        <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">
                            {{ __('Create New Birth Report') }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="gender" class="form-control" wire:model.lazy="gender">
                    ...
                    <table width="100%" class="table table-hover" id="">
                        ...
                        <tbody>
                            @forelse ($BirthReports as $BirthReport)
                                <tr>
                                    <td>{{ $BirthReport->patient->name }}</td>
                                    <td>{{ $BirthReport->description }}</td>
                                    <td>{{ $BirthReport->employee->name }}</td>
                                    <td>{{ $BirthReport->gender }}</td>
                                    <td class="text-right">
